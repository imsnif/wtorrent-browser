...
function _periodicUpdate() {
  this.emitChange()
  // TODO: remove me!
  TorrentActionCreators.update({infoHash: 1, name: "Fake torrent", downloadSpeed: "10", uploadSpeed: "10", progress: "0.5"})
  TorrentActionCreators.update({infoHash: 2, name: "Fake torrent2", downloadSpeed: "10", uploadSpeed: "10", progress: "0.5"})
